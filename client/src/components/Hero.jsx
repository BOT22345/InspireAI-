...
const Hero = () => {
  ...
  return (
    <>
    <div className='px-4 py-80 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-[url(/gradient_background.jpg)] bg-cover bg-no-repeat min-h-screen'>
        <div className="text-center mb-6 ">
          ...
          <p className='mt-4 max-w-xs sm:ma x-w-lg 2xl:max-w-xl m-auto max-smm:text-xs text-gray-600 '>Transform your content creation with our suite of premium AI tools. Write articles, generate images, and enhance your workflow</p>
        </div>
