  ...
  return (
        <div className='px-4 sm:px-20 xl:px-32 py-24'>
            <div className='text-center'>
                <h2 className='text-white-700 text-[60px] font-semibold'>Loved by <span className="text-primary">Creators</span></h2>
                <p className='text-gray-500 max-w-lg mx-auto text-xl'>Don't just take our word for it. Here's what our users are saying.</p>
            </div>
